...
load("D:/AQI/AQ_data_all_clean_24h.RData")
...
save(AQ_data_AQI,file="D:/AQI/AQ_data_AQI_24h.Rdata")
...
load("D:/AQI/AQ_data_AQI_24h.Rdata")
...
save(AQ_data_AQI,file="D:/AQI/AQ_data_AQI_counts_24h.Rdata")
...
load("D:/AQI/AQ_data_AQI_counts_24h.Rdata")
...
save(AQ_data_AQI_Pollutant, file="D:/AQI/AQI_final_24h.Rdata")
...
load("D:/AQI/AQI_final_24h.Rdata")
...
# jpeg('Z:/_SHARED_FOLDERS/Air Quality/Phase 2/AQI/AQI_annual.jpg',
     ...
     quality = 100, bg = "white", res = 1200, width = 12, height = 9, units = "in")
par(mar=c(4, 10, 9, 2) + 0.3)
oldpar <- par(las=1)
